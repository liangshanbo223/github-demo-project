...
const defaultValues: Record<InType, Inbound> = {
  ...
  tuic: <TUIC>{ type: InTypes.TUIC, congestion_control: "bbr", zero_rtt_handshake: true, tls_id: 0 },
  hysteria2: <Hysteria2>{ type: InTypes.Hysteria2, up_mbps: 100, down_mbps: 100, tls_id: 0, masquerade: { type: "proxy", url: "http://127.0.0.1:80", rewrite_host: true } },
  vless: <VLESS>{ type: InTypes.VLESS, tls_id: 1, flow: 'xtls-rprx-vision', transport: {} },
